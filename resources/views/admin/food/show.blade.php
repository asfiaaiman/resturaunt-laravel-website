...
<a href="{{route('foods')}}" class="btn btn-secondary">Back <i class="fas fa-chevron-left"></i></a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form id="" method="POST" action="{{route('foods.storeStatus')}}">
                                        @csrf
                                        <input type="hidden" name="requestid" value="{{$food['id']}}">
                                        <div class="box-body">
