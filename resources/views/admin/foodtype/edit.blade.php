    ...
    <div class="flip-box">
      <div class="flip-box-front text-center" style="background-image: url('https://s25.postimg.cc/frbd9towf/cta-2.png');">
        <div class="inner color-white">
          <h3 class="flip-box-header">Edit Food Categories</h3>
          <p>It is important to edit the mistakes in categories of the food</p>
      ...
      <div class="flip-box-back text-center" style="background-image: url('https://s25.postimg.cc/frbd9towf/cta-2.png');">
        <div class="inner color-white">
          <h3 class="flip-box-header">Edit the Name of Category</h3>
          <form action="{{ route('foodtypes.update', [$foodtype->id]) }}" method="post">
              @csrf
              <input name="_method" type="hidden" value="PATCH">
              <div class="form-group">
                  <input type="text" name="name" id="name" class="form-control text-black" value="{{$foodtype->name}}"  required placeholder="Name of the Category">
              </div>
              <div>
